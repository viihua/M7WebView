...
- (void)M7UserContentController:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation;
@end
...
@interface M7WebView : WKBaseWebView

@property (nonatomic, retain) WKWebView *webView;
@property (nonatomic,   strong) NSMutableURLRequest *willRequest;  //加载页面的URL
@property (nonatomic,   copy) NSString *currentURLString;  //当前页面的URL
@property (nonatomic,   weak) id<M7WKScriptMessageHandler> messageHandlerDelegate;
