...
#import "M7URLProtocol.h"
#import <UIKit/UIKit.h>

static NSString* const M7URLProtocolKey = @"M7URLProtocol";

@interface M7URLProtocol ()<NSURLSessionDelegate,NSURLConnectionDelegate,NSURLConnectionDataDelegate>

@property (nonnull,strong) NSURLSessionDataTask *task;

@end

@implementation M7URLProtocol
...
+ (BOOL)canInitWithRequest:(NSURLRequest *)request
{
    ...
    {
        //看看是否已经处理过了，防止无限循环
        if ([NSURLProtocol propertyForKey:M7URLProtocolKey inRequest:request])
            return NO;
        return YES;
    }
    return NO;
...
- (void)startLoading
{
    ...
    [NSURLProtocol setProperty:@YES forKey:M7URLProtocolKey inRequest:mutableReqeust];
