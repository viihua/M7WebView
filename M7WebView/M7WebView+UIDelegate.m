//
//  M7WebView+UIDelegate.m
//  Pkit
//
//  Created by DevMan7 on 2017/12/25.
//  Copyright © 2017年 llyouss. All rights reserved.
//

#import "M7WebView+UIDelegate.h"

@implementation M7WebView (UIDelegate)
...
- (void)webView:(WKWebView *)webView runJavaScriptAlertPanelWithMessage:(nonnull NSString *)message initiatedByFrame:(nonnull WKFrameInfo *)frame completionHandler:(nonnull void (^)(void))completionHandler
{
    ...
    [self M7presentViewController:alertController animated:YES];
}
...
- (void)M7presentViewController:(UIViewController *)viewControllerToPresent animated:(BOOL)flag{
