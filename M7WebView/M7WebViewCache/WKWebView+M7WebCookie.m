...
static NSString* const M7WKCookiesKey = @"org.skyfox.M7WKShareInstanceCookies";

@implementation WKWebView (M7WebCookie)
...
- (void)insertCookie:(NSHTTPCookie *)cookie
{
    @autoreleasepool {
        ...
        NSMutableArray *localCookies =[NSKeyedUnarchiver unarchiveObjectWithData: [[NSUserDefaults standardUserDefaults] objectForKey: M7WKCookiesKey]];
        ...
        [[NSUserDefaults standardUserDefaults] setObject:cookiesData forKey:M7WKCookiesKey];
...
- (NSMutableArray *)sharedHTTPCookieStorage
{
    @autoreleasepool {
        ...
        /** 获取自定义存储的cookies */
        NSMutableArray *cookies = [NSKeyedUnarchiver unarchiveObjectWithData: [[NSUserDefaults standardUserDefaults] objectForKey: M7WKCookiesKey]];
