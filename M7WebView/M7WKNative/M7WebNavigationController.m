...
#import "M7WebNavigationController.h"
#import "M7WKPanGestureRecognizer.h"
#import <UIKit/UIGestureRecognizerSubclass.h>

@interface M7WebNavigationController ()<UIGestureRecognizerDelegate>

@property (nonatomic,retain)M7WKPanGestureRecognizer *pan;

@property (assign, nonatomic) BOOL animatedFlag;

@end

@implementation M7WebNavigationController
...
- (void)viewDidLoad {
    ...
    _pan = [[M7WKPanGestureRecognizer alloc]initWithTarget:self action:@selector(pan:)];
    _pan.delegate = self;
